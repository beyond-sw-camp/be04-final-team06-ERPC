<template>
    <div class="regist-content">
        ...
        <div class="contract-regist-btn-div1">
            <button class="contract-regist-btn1">계약서 등록하기</button>
        </div>
    </div>
</template>
...
.contract-search-btn-div1,
.contract-regist-btn-div1 {
    display: flex;
...
.contract-search-btn1,
.contract-regist-btn1 {
    padding: 10px 20px;
    font-size: 16px;
    text-align: center;
    border: none;
