        ...
        <div class="customer-process-box">
            ...
            <div class="customer-process-box-detail">
                <div class="process-info">
                    ...
                    <p class="process-date">2024-04-01</p>
                </div>
                <button class="customer-process-detail">
                    해당 거래처는 납기 일자 꼭 지켜야 됩니다~ 벌써 클레임 전화 10통 받았어요.
                </button>
                <div class="process-btn">
                    <button class="process-edit">수정</button>
                    <button class="process-delete">삭제</button>
                </div>
                <div class="process-reply">
                    <input type="text" id="process-reply-box" class="process-reply-box" placeholder="내용을 입력해주세요.">
                    <button class="process-regist">등록하기</button>
                </div>
            </div>
        </div>
    </div>
